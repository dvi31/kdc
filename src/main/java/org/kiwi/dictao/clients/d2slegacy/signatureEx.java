...
import com.dictao.d2slegacy.ws.*;
...
import org.kiwi.dictao.responses.d2slegacy.signatureEx.*;
import java.net.URL;
...
public class signatureEx extends StandardWebService {
    ...
    private static final String WSDL_D2S_INTERFACE_FRONT_END = "/wsdl/dxs/42/D2SInterface.wsdl";
    ...
    public void parseAndRun(String[] arguments) {
        ...
        try {
            ...
            D2SSoap d2sPort = createPort(wsUri, wsdlUri, buildSSLSocketFactory(), soapMessage);

            beginCall();

            D2SResponseEx maReponse = d2sPort.signatureEx(requestId, transactionId, tag, maSignature, maDetached, signatureFormat.toString(), signatureType.toString(), signatureParameter, mesParamsPlugins);
    ...
    public D2SSoap createPort(URL wsUri, URL wsdlUri, SocketFactory sslFactory, boolean soapMessage) {
        if (wsdlUri == null) {
